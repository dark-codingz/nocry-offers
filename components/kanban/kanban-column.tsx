...
export function KanbanColumn({ status, offers }: KanbanColumnProps) {
  ...
  return (
    <section className={`min-h-[68vh] rounded-2xl border bg-white/12 p-3 shadow-xl backdrop-blur-xl ${border}`}>
      ...
      <header className="flex items-center justify-between rounded-xl border-b border-white/25 bg-white/[0.15] px-2 py-2 shadow-md backdrop-blur-lg">
        ...
        <span className="rounded-lg bg-white/20 px-2 py-0.5 text-sm font-medium text-white/80 shadow-sm backdrop-blur-sm">
          {offers.length}
        </span>
      </header>
